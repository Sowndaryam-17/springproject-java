...
<div class="col-md-12 col-sm-12">
	...
	<div class="form-group col-md-6 col-sm-6">
	  ...
	  <div class="form-group col-md-6 col-sm-6">
 <input type="text" class="form-control input-sm"  readonly="readonly" name="sellerId"id="sellerId" value="${flat.sellerId} "style="display: none;" ></div> 
...
<form action="view.do" >
 <input type="text" class="form-control input-sm" name="sellerId" id="sellerId" value="${flat.sellerId}" style="display: none;">
