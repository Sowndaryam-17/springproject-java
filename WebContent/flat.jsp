...
<head>
  ...
  #section2 {padding-top:100px;height:900px;color: #fff; background-color: white;}
  #section3 {padding-top:40px;height:900px;color: #fff; background-color: white;}
  #section4 {padding-top:60px;height:900px;color: #fff; background-color: white;}
    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-center">
          ...
          <li><a href="index.jsp#section5">Contact</a></li>
             </ul>
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-center">
          ...
          <li><a href="#section3">Update Posted Flat</a></li>
           ...
           <li><a href="#section4">View Customer </a></li>
             </ul>
            <!-- Trigger the modal with a button -->
...
<div class="col-md-12 col-sm-12">
	...
	<div class="form-group col-md-6 col-sm-6">
	  ...
	  <div class="form-group col-md-6 col-sm-6">
 <input type="text" class="form-control input-sm"  readonly="readonly" name="sellerId"id="sellerId" value="${Status} " style="display:none ;"></div> 
    ...
    <!--     
	 ...
	 -->
        ...
        <div class="form-group col-md-6 col-sm-6">
          <h4 style="color: black">Upload your FlatImage</h4>
...
<div align="center">
										      ...
										      <c:forEach var="flat" items="${flt}">
											   <tr>
												...
												<td style="color: black"><c:out value="${flat.status}" /></td>
											</tr>
										</c:forEach> 
									</table>
									<br>
                 ...
                 <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i  aria-hidden="true"></i></span>
									<input type="text"  class="form-control"value="${list1.status}" name="status" id="status"  placeholder="Enter status" required/>
								</div>
							</div>
						</div>
...
<script type="text/javascript">fnShow('<c:out value= "${show}"/>');</script>
...
<form action="viewCustomer.do" >
 <input type="text" class="form-control input-sm" name="sellerId" id="sellerId" value="${Status}"style="display:none;">
<center><input type="submit" class="btn btn-primary" value="View Customer"/></center>
</form>
<br>
<br>
<br>
<br>
<h1 style="color: black">${sellerdetail.apartmentName}</h1>
...
<div align="center">
										      ...
										      <c:forEach var="sellerdetail" items="${sellerdetails}">
											   <tr>
												
												<td style="color: black"><c:out value="${sellerdetail.apartmentName}" /></td>
												<td style="color: black"><c:out value="${sellerdetail.flatNumber}" /></td>
												<td style="color: black"><c:out value="${sellerdetail.name}" /></td>
												<td style="color: black"><c:out value="${sellerdetail.emailId}" /></td>
												<td style="color: black"><c:out value="${sellerdetail.phoneNumber}" /></td>
...
<script type="text/javascript">fnShow3('<c:out value= "${show3}"/>');</script>
