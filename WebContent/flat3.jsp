         ...
         <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <div class="form-group">
                    <div> <input type="text" class="form-control input-sm"  readonly="readonly" name="sellerId"id="sellerId" value="${list1.sellerId} " style="display: none;" ></div> 
     				<label for="bname" class="cols-sm-2 control-label">Flat Number</label>
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="FlatNumber" id="FlatNumber"  placeholder="Enter FlatNumber" value="${list1.flatNumber}" required/>
								</div>
							</div>
							<br>
							<div class="form-group ">
                   ...
                   <form  action=updateflat.do method="get" >                   
                    ...
                    <div class="form-group">
                    <div> <input type="text" class="form-control input-sm" name="sellerId" id="sellerId" value="${list1.sellerId}" style="display: none;">
                     </div>
